      ...
      <article class="question-card">
        ...
        <div>
          ...
          <p>
            ...
            behavior co-evolve? Stochastic actor-oriented models compare visible behaviors—social participation, drinking, and smoking—with less
    ...
    <div class="foundation-grid">
      <article class="foundation-card">
        ...
        <p class="foundation-summary">
          ...
          the pandemic, and over ordinary time—with consequences from depressive symptoms to mortality. Newly accepted work extends this lens to
